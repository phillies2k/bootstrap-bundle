...
class Configuration implements ConfigurationInterface
{
    ...
    public function getConfigTreeBuilder()
    {
        ...
        $rootNode
            ...
            ->prototype('array')->end()
            ->end()
            ->scalarNode('addon_tooltip')->defaultNull()->end()
            ->scalarNode('addon_tooltip_placement')->defaultNull()->end()
            ...
            ->scalarNode('addon_tooltip')->defaultValue(array('null', 'string'))->end()
            ->scalarNode('addon_tooltip_placement')->defaultValue(array('null', 'string'))->end()
